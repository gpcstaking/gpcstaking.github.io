...
If no successful withdrawal occurs for 180 days, all remaining personal power expires. Additional orders do not reset this inactivity clock. Expired users are cleared lazily during their next action or by the permissionless batch expiry function. Batch expiry is disabled while the protocol is paused.
