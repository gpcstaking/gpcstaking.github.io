...
test("server-renders the GPC mining application shell", async () => {
  ...
  assert.doesNotMatch(source, /90% 到目标钱包|5% 买入 XDK 并销毁|5% buys and burns XDK/);
